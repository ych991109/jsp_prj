	...
	<div class="txt">
		...
		<div class="tabMenu">
			<ul class="pageTab">
				...
				<li class="on"><a href="http://localhost/paik_prj/paik/coffeMenuPage.jsp">커피</a></li>
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img src="http://localhost/paik_prj/common/images/ICED-%EC%9B%90%EC%A1%B0%EC%BB%A4%ED%94%BC-450x588.png" class="menuItem"/>
					<p><strong>원조커피(ICE)</strong></p>
				</div>
				<div class="swiper-slide">
					<img src="http://localhost/paik_prj/common/images/%EB%B9%BDs-%EB%9D%BC%EB%96%BCICED-450x588.png" class="menuItem"/>
					<p><strong>카페라떼(ICED)</strong></p>
				</div>
				<div class="swiper-slide">
					<img src="http://localhost/paik_prj/common/images/%EC%95%84%EC%83%B7%EC%B6%94-450x588.png" class="menuItem"/>
					<p><strong>아이스티샷추가(아샷추)</strong></p>
				</div>
			</div>
