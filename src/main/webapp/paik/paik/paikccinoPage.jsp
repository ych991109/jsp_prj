	...
	<div class="txt">
		...
		<div class="tabMenu">
			<ul class="pageTab">
				...
				<li class="on"><a href="http://localhost/paik_prj/paik/paikccinoPage.jsp">빽스치노</a></li>
			</ul>
		</div>
	</div>
</div>
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img src="http://localhost/paik_prj/common/images/%EC%9B%90%EC%A1%B0%EB%B9%BD%EC%8A%A4%EC%B9%98%EB%85%B8-SOFT-450x588.png" class="menuItem"/>
					<p><strong>원조빽스치노(SOFT)</strong></p>
				</div>
				<div class="swiper-slide">
					<img src="http://localhost/paik_prj/common/images/%EC%99%84%EC%A0%84%EB%94%B8%EA%B8%B0%EB%B0%94%EB%82%98%EB%82%98-SOFT-450x588.png" class="menuItem"/>
					<p><strong>딸기바나나빽스치노(SOFT)</strong></p>
				</div>
				<div class="swiper-slide">
					<img src="http://localhost/paik_prj/common/images/%EC%99%84%EC%A0%84%EC%B4%88%EC%BD%94%EB%B0%94%EB%82%98%EB%82%98_%EB%B9%BD%EC%8A%A4%EC%B9%98%EB%85%B8-SOFT-450x588.png" class="menuItem"/>
					<p><strong>초코바나나빽스치노(SOFT)</strong></p>
				</div>
				<div class="swiper-slide">
					<img src="http://localhost/paik_prj/common/images/%ED%94%BC%EC%8A%A4%ED%83%80%EC%B9%98%EC%98%A4%EB%B9%BD%EC%8A%A4%EC%B9%98%EB%85%B8-SOFT-450x588.png" class="menuItem"/>
					<p><strong>피스타치오빽스치노(SOFT)</strong></p>
				</div>
			</div>
