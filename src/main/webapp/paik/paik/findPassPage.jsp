...
$(function(){
	$("#passFindBtn").click(function() {
		window.location.href = "http://localhost/paik_prj/paik/findPassSuccessPage.jsp";
	});
});//ready()
</script>
...
<div class="sub_section cmnt_wrap">
    <div class="container" style="max-width: 600px; margin: 0 auto; text-align: center;">
        ...
        <form action="" id="" method="post">
            ...
            <table>
            	<tr>
            		<td><label for="id" class="contentTxt">아이디</label><input type="text" id="id" name="id" class="inputBox"/></td>
            	</tr>
            	<tr>
            	...
            	<tr>
            		<td><input type="button" id="passFindBtn" class="passFindBtn" value="확인"/></td>
            	</tr>
            </table>
            </div>
        </form>
